---
title: 'An introduction to benchdamic - Quadram workshop'
author: Matteo Calgaro^[mcalgaro93@gmail.com]
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{An introduction to benchdamic - Quadram workshop}
...
# An introduction to benchdamic - Quadram workshop
...
During the workshop we will have the first 40 minutes of active coding
(using the supplied examples). Questions are being addressed afterwards.
